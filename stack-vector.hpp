...
{
    /// STL-compliant container with flexible size, fixed maximum size and allocation on the stack. Compatible with std::vector, not std::array.
    ...
    public:
        ...
        reference at(const size_type n)
        {
            if (n < size())
                ...
                throw std::out_of_range("stack_vector::StackVector");
        }
